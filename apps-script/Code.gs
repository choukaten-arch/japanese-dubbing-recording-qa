...
const SOUND_EFFECT_WORKS = Object.freeze([
  {
    ...
    workTitle: "魔女宅急便",
    cues: [
      ["00:32.80–00:56.20", "柴門開啟與木柴搬運"],
      ["00:59.40–01:11.20", "划火柴與火焰燃燒"],
      ["01:28.70–01:46.40", "爐具、烤盤與爐門"],
      ["02:23.40–02:25.60", "時鐘畫面的窗外鳥鳴"],
      ["02:35.50–03:14.50", "開爐、取派、收拾、奔跑與起飛"],
      ["03:24.50–04:05.00", "風雨與雷"],
      ["04:43.50–04:47.00", "門鈴"],
      ["05:19.50–05:22.00", "關門"],
    ],
  },
  {
    workSlug: "maruko",
